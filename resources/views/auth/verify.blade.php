                ...
                <div class="card-body">
                    @if (session('resent'))
                        <div class="alert alert-success" role="alert">
                            Reenviamos um email para você com o link de verificação.
                        </div>
                    @endif

                    Antes de utilizar os recursos da aplicação, por favor, verique seu email por meio do link de verificação que encaminhamos para seu email.
